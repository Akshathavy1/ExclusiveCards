...
namespace ExclusiveCard.WebAdmin.Controllers
{
    ...
    public class ImageController : BaseController
    {
        ...
        public ImageController(IMerchantImageService merchantImageService,
        ...
        public async Task<ActionResult> GetImage(string path, int id)
        {
            try
            {
                ...
                {
                    image = await _merchantImageService.GetByIdAsync(id);
                }
                ...
                if (!string.IsNullOrEmpty(path))
                {
                    ...
                    {
                        await _merchantImageService.DeleteByMerchantImagePath(path);
                    }
                }
