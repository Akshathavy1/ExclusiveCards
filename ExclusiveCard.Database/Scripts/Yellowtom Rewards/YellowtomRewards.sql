...
SELECT @Name ='Yellowtom Rewards'
SELECT @DisplayName = 'Yellowtom Rewards'
SELECT @URL = 'https://yellowtom.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'yellowtom'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'yellowtom.css'
...
BEGIN
	...
	SELECT @DefaultRegion = Id FROM [CMS].[WhiteLabelSettings] WHERE [Name] = 'Belfast Rewards'
END
