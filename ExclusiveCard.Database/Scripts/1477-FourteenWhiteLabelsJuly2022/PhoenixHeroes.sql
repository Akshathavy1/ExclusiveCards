...
BEGIN
	...
	SELECT @CharityName = 'Phoenix Heroes'
	SELECT @CharityUrl = 'https://www.phoenixheroes.co.uk/'
END
ELSE
BEGIN
...
SELECT @Name ='Phoenix Heroes Rewards'
SELECT @DisplayName = 'Phoenix Heroes Rewards'
SELECT @URL = 'https://phoenixheroes.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'phoenix-heroes'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'phoenix-heroes.css'
...
SELECT @Address = 'Phoenix Heroes CIC, Castle House, South Street, Ashby-De-La-Zouch, Leicestershire, LE65 1BR'
...
Declare @registrationCode Varchar(max) = 'PHRSSBR01' --'RegCode'
...
BEGIN
	...
	VALUES
	 ('GB', @Instagram,'https://www.instagram.com/phoenixheroes/', @NewWhiteLabelId),
	 ('GB', @FaceBook,'https://www.facebook.com/phoenixheroes.co.uk', @NewWhiteLabelId),
	 ('GB', @Twitter,'https://twitter.com/phoenixheroes', @NewWhiteLabelId),
	 ('GB', @LinkedIn,'https://www.linkedin.com/company/phoenix-heroes/', @NewWhiteLabelId),
	 ('GB', @YouTube,'https://www.youtube.com/channel/UCA0yu2XtHB26BB_oexL3E_w/about?view_as=public', @NewWhiteLabelId)
END
