...
SELECT @Name ='Northampton University Rewards'
SELECT @DisplayName = 'Northampton University'
SELECT @URL = 'https://northampton.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'northampton-university'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'northampton-university.css'
...
SELECT @Address = 'Waterside Campus, University Drive, Northampton, NN1 5PH'
...
BEGIN
	...
	VALUES
	 ('GB', @Instagram,'https://www.instagram.com/uninorthants', @NewWhiteLabelId),
	 ('GB', @FaceBook,'https://www.facebook.com/UniversityofNorthampton', @NewWhiteLabelId),
	 ('GB', @Twitter,'https://twitter.com/UniNorthants', @NewWhiteLabelId)
END
