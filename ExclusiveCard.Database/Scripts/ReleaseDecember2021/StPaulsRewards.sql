...
BEGIN
	...
	SELECT @CharityName = 'St Pauls FP'
	SELECT @CharityUrl = 'https://stpaulsfinancial.co.uk/'
END
ELSE
BEGIN
...
SELECT @Name ='St Paul''s FP Rewards'
SELECT @DisplayName = 'St Paul''s FP Rewards'
SELECT @URL = 'https://stpauls.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'st-pauls-fp'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'st-pauls-fp.css'
...
Declare @registrationCode Varchar(max) = 'SPFPSR01' --'RegCode'
Declare @DiamondRegistrationCode Varchar(max) = 'SPFPDR01' --'RegCode'
...
BEGIN
	...
	VALUES
	 ('GB', @LinkedIn,'https://www.linkedin.com/company/st-pauls-financial-planning', @NewWhiteLabelId)
END
