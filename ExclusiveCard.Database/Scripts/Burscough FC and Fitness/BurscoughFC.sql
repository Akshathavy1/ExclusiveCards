...
BEGIN
	...
	SELECT @CharityName = 'Burscough FC'
	SELECT @CharityUrl = 'https://burscoughfc.com/'
END
ELSE
BEGIN
...
SELECT @Name ='Burscough FC Rewards'
SELECT @DisplayName = 'Burscough FC Rewards'
SELECT @URL = 'https://burscoughfc.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'burscough-fc'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'burscough-fc.css'
...
BEGIN
	...
	VALUES
	 ('GB', @Twitter,'https://twitter.com/BurscoughFC1946', @NewWhiteLabelId)
END
