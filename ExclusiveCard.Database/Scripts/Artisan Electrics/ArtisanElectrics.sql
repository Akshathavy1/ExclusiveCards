...
SELECT @Name ='Artisan Electrics Rewards'
SELECT @DisplayName = 'Artisan Electrics Rewards'
SELECT @URL = 'https://artisanelectrics.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'artisan-electrics'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'artisan-electrics.css'
