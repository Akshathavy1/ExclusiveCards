...
SELECT @Name ='Dorking Wanderers Rewards'
SELECT @DisplayName = 'Dorking Wanderers FC'
SELECT @URL = 'https://Dorkingwanderersfc.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'dorking-wanderers'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'dorking-wanderers.css'
...
SELECT @CharityName = 'Dorking Wanderers FC'
SELECT @CharityUrl = 'https://www.dorkingwanderers.com'
...
BEGIN
	...
	VALUES
	 ('GB', @Instagram,'https://www.instagram.com/dwfcofficial', @NewWhiteLabelId),
	 ('GB', @FaceBook,'https://www.facebook.com/DorkingWanderersFC', @NewWhiteLabelId),
	 ('GB', @Twitter,'https://twitter.com/DorkingWDRS', @NewWhiteLabelId),
     ('GB', @LinkedIn,'https://www.linkedin.com/company/Dorking-Wanderers-FC', @NewWhiteLabelId),
     ('GB', @YouTube,'https://www.youtube.com/channel/UC_i2iAybzL7Q_KeNPu6P3pA', @NewWhiteLabelId)
END
...
Declare @cardProvider Varchar(max) = 'Dorking Wanderers Rewards' --'Card Provider'
Declare @registrationCode Varchar(max) = 'DWS2021' --'RegCode'
