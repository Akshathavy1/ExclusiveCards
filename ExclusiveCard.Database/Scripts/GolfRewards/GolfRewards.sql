...
SELECT @Name ='Golf Rewards'
SELECT @DisplayName = 'Golf Rewards'
SELECT @URL = 'https://golf.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'golf-rewards'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'golf-rewards.css'
