...
SELECT @Name ='Trustist Rewards'
SELECT @DisplayName = 'Trustist Rewards'
SELECT @URL = 'https://trustist.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'trustist'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'trustist.css'
...
BEGIN
	...
	SELECT @DefaultRegion = Id FROM [CMS].[WhiteLabelSettings] WHERE [Name] = 'York Rewards'
END
