...
SELECT @Name ='Ipswich Rewards'
SELECT @DisplayName = 'Ipswich Rewards'
SELECT @URL = 'https://ipswich.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'Ipswich'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'Ipswich.css'
...
Declare @registrationCode Varchar(max) = 'IPSSR01' --'RegCode'
Declare @DiamondRegistrationCode Varchar(max) = 'IPSOWD01' --'RegCode'
