...
SELECT @Name ='Crosby Rewards'
SELECT @DisplayName = 'Crosby Rewards'
SELECT @URL = 'https://crosby.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'crosby'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'Crosby.css'
...
Declare @registrationCode Varchar(max) = 'CRRSSR01' --'RegCode'
Declare @DiamondRegistrationCode Varchar(max) = 'CRRSDR01' --'RegCode'
