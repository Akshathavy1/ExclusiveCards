...
SELECT @Name ='Harrow Rewards'
SELECT @DisplayName = 'Harrow Rewards'
SELECT @URL = 'https://harrow.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'Harrow'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'Harrow.css'
...
Declare @registrationCode Varchar(max) = 'HARSR01' --'RegCode'
Declare @DiamondRegistrationCode Varchar(max) = 'HAROWD01' --'RegCode'
