...
SELECT @Name ='Manchester Trafford Rewards'
SELECT @DisplayName = 'Manchester Trafford Rewards'
SELECT @URL = 'https://trafford.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'trafford'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'trafford.css'
SELECT @Logo = 'trafford.svg' 
...
Declare @registrationCode Varchar(max) = 'MTRSPR01' --'RegCode'
