...
SELECT @Name ='York Rewards'
SELECT @DisplayName = 'York Rewards'
SELECT @URL = 'https://york.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'york'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'york.css'
...
Declare @registrationCode Varchar(max) = 'YOSRC01' --'RegCode'
Declare @DiamondRegistrationCode Varchar(max) = 'YODRC01' --'RegCode'
