...
SELECT @Name ='Oxford North Rewards'
SELECT @DisplayName = 'Oxford North Rewards'
SELECT @URL = 'https://oxfordnorth.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'oxford_north'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'oxford_north.css'
SELECT @Logo = 'oxford_north.svg' 
...
Declare @registrationCode Varchar(max) = 'OXNSPR01' --'RegCode'
