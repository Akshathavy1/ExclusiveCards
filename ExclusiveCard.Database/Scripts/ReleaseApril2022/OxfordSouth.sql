...
SELECT @Name ='Oxford South Rewards'
SELECT @DisplayName = 'Oxford South Rewards'
SELECT @URL = 'https://oxfordsouth.exclusiverewards.co.uk' --<< LIVE
SELECT @Slug = 'oxford_south'
SELECT @CompanyNumber ='11616720'
SELECT @CSSFile = 'oxford_south.css'
SELECT @Logo = 'oxford_south.svg' 
...
Declare @registrationCode Varchar(max) = 'OXSSPR01' --'RegCode'
